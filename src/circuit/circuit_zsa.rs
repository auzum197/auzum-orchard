...
mod tests {
    ...
    fn generate_circuit_instance<R: Rng + CryptoRng>(
    ...
    fn generate_self_transfer_circuit_instance<R: Rng + CryptoRng>(
        is_zatoshi_asset: bool,
        rng: R,
    ) -> (Circuit, Instance) {
    ...
    /// `(split_flag = 1) => (is_zatoshi_asset = 0)`.
    fn generate_split_note_circuit_instance<R: Rng + CryptoRng>(rng: R) -> (Circuit, Instance) {
    ...
    fn generate_circuit_instance_inner<R: Rng + CryptoRng>(
        is_zatoshi_asset: bool,
