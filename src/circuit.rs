...
use halo2_proofs::{
    circuit::Value,
    plonk::{
        self, Advice, BatchVerifier, Column, Fixed, Instance as InstanceColumn, Selector,
        SingleVerifier,
    },
...
use crate::{
    ...
    note::{ExtractedNoteCommitment, Note, Rho, nullifier::Nullifier},
...
impl<Lookup: PallasLookupRangeCheck + Send + Sync + 'static> Config<Lookup> {
