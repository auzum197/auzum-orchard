...
mod tests {
    ...
    fn test_hash_bundle_txid_data_for_orchard_v2() {
        ...
        assert_eq!(
            ...
            // This fork's `rand` 0.10 input bundle; QED-it's value is pinned by
            // `digests_match_qedit_reference_bundles`.
            "1cb6b178022e0b786e5d5703122e1ce42f6689e3759cf80b256823024bc40b57"
        );
    }
    ...
    fn test_hash_bundle_txid_data_for_orchard_v3() {
        ...
        assert_eq!(
            ...
            // This fork's `rand` 0.10 input bundle; QED-it's value is pinned by
            // `digests_match_qedit_reference_bundles`.
            "067bb2a3cebe9ed6529de9e76b1f9f2e2a1335f0ebc8045c9274bef546196ace"
        );
    }
    ...
    fn test_hash_bundle_txid_data_for_ironwood_v3() {
        ...
        assert_eq!(
            ...
            // This fork's `rand` 0.10 input bundle; QED-it's value is pinned by
            // `digests_match_qedit_reference_bundles`.
            "842ab8e25eac5032bcf1708124410d9c3285281960d900d807964f6382ebb58d"
        );
    }
    ...
    fn test_hash_bundle_txid_data_for_zsa() {
        ...
        assert_eq!(
            ...
            // This fork's `rand` 0.10 input bundle; QED-it's value is pinned by
            // `digests_match_qedit_reference_bundles`.
            "ea28467c0590e11db1d2d0514023773d5cfcbf7e2ba956a61fd07988dde96fb9"
        );
    }
    ...
    fn test_hash_bundle_auth_data_for_orchard_v2() {
        ...
        assert_eq!(
            ...
            // This fork's `rand` 0.10 input bundle; QED-it's value is pinned by
            // `digests_match_qedit_reference_bundles`.
            "c38c6cbd339df2786204a67462b186393d6c34f9a949877b56bbf209faa9ee86"
        );
    }
    ...
    fn test_hash_bundle_auth_data_for_orchard_v3() {
        ...
        assert_eq!(
            ...
            // This fork's `rand` 0.10 input bundle; QED-it's value is pinned by
            // `digests_match_qedit_reference_bundles`.
            "0df358ea3476fe6987ada9fb4deab6da552d66e84ae3635d3cce94cd424319b3"
        );
    }
    ...
    fn test_hash_bundle_auth_data_for_ironwood_v3() {
        ...
        assert_eq!(
            ...
            // This fork's `rand` 0.10 input bundle; QED-it's value is pinned by
            // `digests_match_qedit_reference_bundles`.
            "f024b51f6537426ae8617a5fb2fbe339c911e6740f614bbc9490f0fed3488c25"
        );
    }
    ...
    fn test_hash_bundle_auth_data_for_zsa() {
        ...
        assert_eq!(
            ...
            // This fork's `rand` 0.10 input bundle; QED-it's value is pinned by
            // `digests_match_qedit_reference_bundles`.
            "4c5b9055fb647b07f7d0af2b8818b844a229347251f3133b6e8fe787075f0bab"
        );
    }
